...
public class AddressBookDeleteContact {
    ...
    //Method to delete person contact in address book
    public void deleteContact(ArrayList<AddressBookMain.Contacts> contactList) {
    ...
    public void addContactList() {
        ...
        do {
            ...
            System.out.println("\n\t\tEnter E to (E)dit Information of Person:");
            System.out.println("\n\t\tEnter D to (D)elete the Person:");
